...
;(function($){$.fn.searchBar=function(options){options=$.extend({focusingClass:'weui_search_focusing',searchText:"鎼滅储",cancelText:"鍙栨秷"},options);var html='<div class="weui_search_bar">'+
